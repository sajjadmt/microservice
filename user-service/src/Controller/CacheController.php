...
class CacheController extends AbstractController
{
    ...
    #[Route('/debug/test', name: 'debug_test', methods: ['GET'])]
    public function debugTest(): JsonResponse
    {
        // This endpoint is perfect for testing Xdebug
        $debugData = [
        ...
        $processedData = $this->processDebugData($debugData);
        
        return $this->json([
            'success' => true,
            'data' => $processedData,
            'debug_info' => 'This endpoint is ready for debugging with Xdebug'
        ]);
    }
    
    private function processDebugData(array $data): array
    {
        // Add some processing logic for debugging
        $data['processed'] = true;
        $data['processing_time'] = time();
